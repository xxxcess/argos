...
const TOOL_META = {
  ...
  generate_video:    { name: 'Generate video',   desc: 'Creates an image anchor through the selected Image Default, then uses the saved Video Generation provider.', cat: 'Media', ctx: '~150' },
