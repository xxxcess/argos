...
const TOOL_META = {
  ...
  generate_video:    { name: 'Generate video',   desc: 'Creates an image anchor through the selected Image Default, then generates a local depth-parallax video.', cat: 'Media', ctx: '~150' },
