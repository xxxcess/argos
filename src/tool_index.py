...
BUILTIN_TOOL_DESCRIPTIONS: Dict[str, str] = {
    ...
    "manage_quest": "Captain-only scoped Quest tool for the active Quest. Supports status, source inspection, refresh/reindex on explicit Captain request, artifact opening, synthesis requests, and Quest-local memory listing. Never use outside Venture Quest sessions.",
...
class ToolIndex:
    ...
    _KEYWORD_HINTS = {
        ...
        frozenset({"note", "todo", "reminder", "remind", "checklist", "remember to"}):
            {"manage_notes"},
        frozenset({"create video", "generate video", "make video", "render video",
                   "produce video", "create a video", "generate a video",
                   "make a video", "render a video", "create clip",
                   "generate clip", "make clip", "create animation",
                   "generate animation", "make animation", "create movie",
                   "generate movie"}):
            {"generate_video"},
